...
(function() {  
  ...
  var DraggableExtension = function (element) {
	...
	/**
	@author David Daedalus - 18APR13 - theVagrantPhilosopher@yahoo.com
	*/	  
	//calculate xy offset
	var parentOffset = $("#canvas_container").offset(); 
...
/*
			fiddle.stroke5.remove();
			fiddle.stroke6.remove();
			fiddle.draw_connecting_lines(
				fiddle.elementArray[4].attr("cx"), 
				fiddle.elementArray[4].attr("cy"), 
				fiddle.elementArray[4].attr("r"), 
				relX, 
				relY, 
				fiddle.elementArray[5].attr("r"),
				"5"
				);
